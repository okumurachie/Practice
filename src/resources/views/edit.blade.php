...
<div class="edit__content">
    ...
    <div class="form_group">
        <form class="edit-product-form" action="/products/update/{{$product->id}}" method="post">
            @method('PATCH')
            @csrf
        ...
        <form class="edit-product-form" action="/products/imageUpdate/{{$product->id}}" method="post" enctype="multipart/form-data">
            @method('PATCH')
            @csrf
            <div class="edit-product-form__group">
                <div class="edit-product-form__group-title">
                ...
                <div class="edit-product-form__button">
                    <button class="edit-product-form__button-submit" type="submit">画像を変更する</button>
                </div>
            </div>
        </form>
    </div>
